...
const PodCast = () => {
    return (
        <div>
            <h2 className='text-center text-5xl text-gray-600 mt-10'>Our Weekly Program</h2>
            <p className='text-center text-gray-500 mt-5'>Join Our Social Media For More Activities</p>
